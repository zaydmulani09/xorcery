...
export const PRESETS: Preset[] = [
  ...
  { id: 'p19', group: 'hd', name: 'P19 · exchange two bit fields', spec: 'uint32_t t = ((x >> z) ^ x) & y;\nx ^ t ^ (t << z)', note: 'HD 2-20, fields selected by mask y and distance z. Three inputs; the 6-op textbook program is found after ~10^11 candidates (about 9 minutes on an Intel Iris Xe, under a minute on a large discrete GPU), and nothing shorter exists in this ISA.', size: 6, groups: BASE, consts: [], maxLen: 6, hard: true },
